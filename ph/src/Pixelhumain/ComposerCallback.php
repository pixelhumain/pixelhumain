...
defined('CONSOLE_CONFIG') or define('CONSOLE_CONFIG', dirname(__FILE__).'/../../protected/config/console.php');
...
class ComposerCallback
{
    ...
    public static function postInstall(Event $event)
    {
        ...
        echo "\nThank you for choosing PixelHumain!\n\n";
    }
    ...
    private static function pixelhumainAscii(){
        $return = <<<TXT
______ _          _   _   _                       _       
| ___ (_)        | | | | | |                     (_)      
| |_/ /___  _____| | | |_| |_   _ _ __ ___   __ _ _ _ __  
|  __/| \ \/ / _ \ | |  _  | | | | '_ ` _ \ / _` | | '_ \ 
| |   | |>  <  __/ | | | | | |_| | | | | | | (_| | | | | |
\_|   |_/_/\_\___|_| \_| |_/\__,_|_| |_| |_|\__,_|_|_| |_|
