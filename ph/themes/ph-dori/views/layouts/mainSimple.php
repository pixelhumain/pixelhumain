...
<html lang="en" class="no-js">
	...
	<body class="login bggrass">
		...
		$cs->registerScriptFile(Yii::app()->request->baseUrl. '/js/cookie.js' , CClientScript::POS_END);

		$cs->registerCssFile(Yii::app()->request->baseUrl. '/plugins/select2/select2.css');
