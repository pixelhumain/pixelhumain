...
<html lang="en" class="no-js">
	...
	<?php 
		...
		$cs->registerScriptFile(Yii::app()->theme->baseUrl.'/assets/js/angular/angular.min.js', CClientScript::POS_HEAD);
		$cs->registerScriptFile(Yii::app()->theme->baseUrl.'/assets/js/angular/todoList.js',CClientScript::POS_HEAD);
