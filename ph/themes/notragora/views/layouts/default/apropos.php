...
<div class="col-md-12 apropos">
	...
	<h4 class="text-dark">Equipe associative :</h4> 
	...
	<h4 class="text-dark">Ergonomie / Fonctionnalités :</h4>
	<span>Thomas Dulu, Bruno Duriez, Bastien Sander</span>
	<h4 class="text-dark">Design / Graphisme :</h4>
	...
	<h4 class="text-dark">Apports Artistiques et Techniques :</h4>
	...
	<h3 class="text-dark">Apports Participatifs</h3>
	<h4 class="text-dark">Gestion des Usages et Usagers :</h4>
	<span>Nicolas Huguenin, Bruno Duriez</span>
	<h4 class="text-dark">Sensibilisation et formation :</h4>
	<span>Nicolas Huguenin, Bruno Duriez, Thomas Dulu, Cécile Foudi,<br/> Sarah Rousseau, Élise Chevalier</span>
	<h4 class="text-dark">Community Management :</h4>
