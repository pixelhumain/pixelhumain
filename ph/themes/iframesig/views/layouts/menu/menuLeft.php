...
<div class="hidden-xs main-menu-left col-md-2 col-sm-2 padding-10"  data-tpl="menuLeft">
	...
	<div class="menu-left-container">
		...
		<div id="menu-extend">
			...
			<?php if(isset(Yii::app()->session['userId'])){ ?>
			<a href="javascript:elementLib.openForm ( 'person' );" class="menu-button-left pull-right lbl-btn-menu">
			...
			<?php if(isset(Yii::app()->session['userId'])){ ?>
				...
				<?php if(isset(Yii::app()->session['userId'])){ ?>
				<a href="javascript:elementLib.openForm ( 'entry' );" class="menu-button-left pull-right lbl-btn-menu">
				...
				<?php if(isset(Yii::app()->session['userId'])){ ?>
				<a href="javascript:elementLib.openForm ( 'action' );" class="menu-button-left pull-right lbl-btn-menu">
