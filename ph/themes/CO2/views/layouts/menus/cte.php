        ...
        <ul class="dropdown-menu arrow_box">
            ...
            <li class="text-admin">
             ...
             if( Form::canAdmin( (string)$form["_id"] , $form  )) { 
                ...
                <li class="text-admin">
                    <a href="<?php echo Yii::app()->getRequest()->getBaseUrl(true) ?>/survey/co/answers/id/<?php echo $form["id"]."/session/".$form["session"] ?>" class="bg-white">
                        <i class="fa fa-bars"></i> Projets
                    </a>
                </li>
                <li class="text-admin">
                    <a href="<?php echo Yii::app()->getRequest()->getBaseUrl(true) ?>/survey/co/members/id/<?php echo $form["id"]."/session/".$form["session"] ?>" class="bg-white">
                        <i class="fa fa-users"></i> Membres
                    </a>
                </li>
                <li class="text-admin">
                    <a href="<?php echo Yii::app()->getRequest()->getBaseUrl(true) ?>/survey/co/roles/id/<?php echo $form["id"]."/session/".$form["session"] ?>" class="bg-white">
