...
HtmlHelper::registerCssAndScriptsFiles($cssJS, Yii::app()->getModule( "co2" )->getAssetsUrl() );
  ...
  var ListPath = [
      ...
      var ListPath = [
        '<?php echo Yii::app()->getModule( "co2" )->getAssetsUrl() ?>/assets/vendor/bootstrap/js/bootstrap.min.js',
        '<?php echo Yii::app()->getModule( "co2" )->getAssetsUrl() ?>/assets/vendor/bootstrap/css/bootstrap.min.css',
        '<?php echo Yii::app()->getModule( "co2" )->getAssetsUrl() ?>/assets/css/freelancer.css',
        '<?php echo Yii::app()->getModule( "co2" )->getAssetsUrl() ?>/assets/css/CO2/CO2-boot.css',
        '<?php echo Yii::app()->getModule( "co2" )->getAssetsUrl() ?>/assets/css/CO2/CO2-color.css',
        '<?php echo Yii::app()->getModule( "co2" )->getAssetsUrl() ?>/assets/css/CO2/CO2.css',
