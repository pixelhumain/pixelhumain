		...
		<div class="hidden-xs" id="style_selector">
			<div id="style_selector_container">
				...
				<div class="images icons-color">
					<a href="#" id="default"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/color-1.png" alt="" class="active"></a>
					<a href="#" id="style2"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/color-2.png" alt=""></a>
					<a href="#" id="style3"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/color-3.png" alt=""></a>
					<a href="#" id="style4"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/color-4.png" alt=""></a>
					<a href="#" id="style5"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/color-5.png" alt=""></a>
					<a href="#" id="style6"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/color-6.png" alt=""></a>
					<a href="#" id="style7"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/color-7.png" alt=""></a>
					<a href="#" id="style8"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/color-8.png" alt=""></a>
					<a href="#" id="style9"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/color-9.png" alt=""></a>
					<a href="#" id="style10"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/color-10.png" alt=""></a>
				</div>
				<div class="box-title">
					Backgrounds for Boxed Version
				</div>
				<div class="images boxed-patterns">
					<a href="#" id="bg_style_1"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/bg.png" alt=""></a>
					<a href="#" id="bg_style_2"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/bg_2.png" alt=""></a>
					<a href="#" id="bg_style_3"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/bg_3.png" alt=""></a>
					<a href="#" id="bg_style_4"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/bg_4.png" alt=""></a>
					<a href="#" id="bg_style_5"><img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/bg_5.png" alt=""></a>
				</div>
