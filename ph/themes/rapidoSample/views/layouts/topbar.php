...
<header class="topbar navbar navbar-inverse navbar-fixed-top inner">
	...
	<div class="container">
		<div class="navbar-header">
			...
			<!-- start: LOGO -->
			<a class="navbar-brand" href="<?php Yii::app()->createUrl("")?>">
			...
			<ul class="nav navbar-right">
				...
				<li class="dropdown current-user">
					<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
						<img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/avatar-1-small.jpg" class="img-circle" alt=""> <span class="username hidden-xs">Peter Clark</span> <i class="fa fa-caret-down "></i>
					</a>
					<ul class="dropdown-menu dropdown-dark">
						<li>
							<a href="<?php echo Yii::app()->createUrl("/teeo/sample/profile")?>">
								Mon Profile
							</a>
						</li>
						<li>
