var Charts = function() {
	...
	var runChart3 = function() {
		...
		d3.json(themeUrl+'/assets/plugins/nvd3/json/stackedAreaData.txt', function(data) {
			nv.addGraph(function() {
	...
	var runChart5 = function() {
		d3.json(themeUrl+'/assets/plugins/nvd3/json/multiBarHorizontalData.txt', function(data) {
			nv.addGraph(function() {
	...
	var runChart7 = function() {
		d3.json(themeUrl+'/assets/plugins/nvd3/json/cumulativeLineData.json', function(data) {
			nv.addGraph(function() {
