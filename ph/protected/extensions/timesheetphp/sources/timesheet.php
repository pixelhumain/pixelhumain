	...
	private function get_segment($key, $segment, $head_level){
		...
		<div class="segment">
			<div style="margin-left: <?php echo $segment['marginleft']; ?>%;">
				<?php if( $head_level ) : ?><span class="label" ><?php if (is_array($segment["key"])){?> <i class="fa fa-calendar"></i> <?php } ?><?php echo $segment['title']; ?><?php if (is_array($segment["key"])) echo " (".$segment["key"]["address"].")"; ?></span><?php endif; ?>
