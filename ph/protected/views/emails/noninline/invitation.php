	      		...
	      		<table>
				    <tr>
					    <th>
							...
							<a href="#"><img align="right" width="200" src="<?php echo Yii::app()->getRequest()->getBaseUrl(true)."/images/bdb.png"?>" alt="betatest"></a>
							<b><h5>Invitation à rejoindre le r&eacute;seau communecter</h5></b>
							Vous avez &eacute;t&eacute; invit&eacute; au projet Communecter par <?php echo $invitorName?>.<br/>
							Voici son message : <br/>
							<?php echo $message ?>
							<br/><br/>
							Veuillez clicker sur ce lien pour rejoindre <?php echo $invitorName?> et ainsi participer a cette initiative locale pour am&eacute;liorer votre commune.<br/>
							<br/>
