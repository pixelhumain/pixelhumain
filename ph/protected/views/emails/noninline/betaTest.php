<!--
2 params needed :
$logo => url to the simple logo (header)
$logo2 => url to the main logo 
-->
		...
		<table class="row masthead"><tbody><tr> <!-- Masthead -->
			<th class="small-12 large-12 columns first last">
				<table>
					<tr>
						<th>
							<h1 class="text-center">Plateforme en betatest</h1>
							<center>
	      		...
	      		<table>
				    <tr>
					    <th>
					    	...
					    	<a href="#"><img align="right" width="200" height="200" src="<?php echo Yii::app()->getRequest()->getBaseUrl(true)."/images/betatest.png"?>" alt="betatest"></a>
							<b><h5>Beta Test Kesako ?</h5></b>
							<p><b>Merci de vous &ecirc;tre inscrit</b> sur la r&eacute;seau social citoyen libre : Communecter.org.</p>
							<p>De voir chaque jour des nouveaux citoyens qui viennent nous rejoindre c&apos;est un plaisir.</p>

							<p>Nous sommes actuellement en <b>p&eacute;riode de beta test.</b> Beta test ?!?! Kesako ? </p>                 
							<p><b>C&apos;est une ouverture partielle</b> : nous venons de terminer le d&eacute;veloppement de la plateforme et nous avons ouvert la plateforme à des utilisateurs qui nous font des retours (bugs et am&eacute;liorations) afin de la peaufiner, la simplifier y mettre les derniers coups de peinture avant l&apos;ouverture totale.</p>
							<p>Si vous voulez rejoindre l&apos;&eacute;quipe de testeur, vous pouvez envoyer un mail &agrave; <a href="mailto:contact@communecter.org">contact@communecter.org</a> et nous vous ouvrirons les acc&egrave;s.</p>

							<p>A tr&egrave;s bient&ocirc;t sur <a href="www.communecter.org">www.communecter.org</a></p>
							<p>L&apos;&eacute;quipe de Communecter</p>
						</th>
				    </tr>
	  			</table>
    		</th>
        			...
        			<tr>
          				<th>
                  			<center>
                    			...
                    			<h5 align="center" class="text-center">Vous pouvez toujours naviguer sur communecter en mode non connect&eacute; !</h5>
                    			<table class="button text-center"><tr><td><table><tr><td><a href="#">Communecter</a></td></tr></table></td></tr></table>
