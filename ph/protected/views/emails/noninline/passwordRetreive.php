		...
		<table class="row masthead"><tbody><tr> <!-- Masthead -->
			<th class="small-12 large-12 columns first last">
				<table>
					<tr>
						<th>
							<h1 class="text-center">R&eacute;initialisation de mot de passe</h1>
							<center>
	      		...
	      		<table>
				    <tr>
					    <th>
							...
							<b><h5>R&eacute;initialisation de mot de passe</h5></b>
		...
		<table class="row grey"><tbody><tr>
			<th class="small-12 large-12 columns first last">
      			<table>
        			<tr>
          				<th>
							<p class="text-center footercopy">Mail envoy&eacute; depuis communecter.org</p>
		                </th>
						<th class="expander"></th>
        			</tr>
      			</table>
