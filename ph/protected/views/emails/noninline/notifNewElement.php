		...
		<table class="row masthead"><tbody><tr> <!-- Masthead -->
			<th class="small-12 large-12 columns first last">
				<table>
					<tr>
						<th>
							<h1 class="text-center">Nouvel élément sur <?php Yii::app()->name ?></h1>
							<center>
	      		...
	      		<table>
				    <tr>
					    <th>
							...
							<br/>
							<p dir="ltr">
							    Un nouvel élément <?php echo $elementType ?> de type <?php echo $elementType ?> a été créée par <?php echo $elementCreator ?>
							</p>
							<br/>
							<ol>
							    <li dir="ltr">
							        <p dir="ltr">
							            <a href="<?php echo $url?>">Cliquer sur ce lien pour accéder à l'élément.</a>
										<br/>
										<br/>
