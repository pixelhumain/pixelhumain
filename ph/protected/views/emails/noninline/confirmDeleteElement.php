		...
		<table class="row masthead"><tbody><tr> <!-- Masthead -->
			<th class="small-12 large-12 columns first last">
				<table>
					<tr>
						<th>
							<h1 class="text-center">Demande de suppression de l'élément <?php echo $elementName ?></h1>
							<center>
							<!--http://localhost:8888/ph/images/logoLTxt.jpg-->
							<img src="<?php echo Yii::app()->getRequest()->getBaseUrl(true).$logo2 ?>" valign="bottom" alt="logo" align="center" class="text-center">
							</center>
						</th>
						<th class="expander"></th>
        			</tr>
	      		...
	      		<table>
				    <tr>
					    <th>
							...
							<a href="#"><img align="right" width="200" src="<?php echo Yii::app()->getRequest()->getBaseUrl(true).$logo2?>" alt="1+1=3"></a>
							<p dir="ltr">
							    Bonjour,
							</p>
							<br/>
							...
							<ol>
							    <li dir="ltr">
							        <p dir="ltr">
							        	...
							        	<br/>
							        	Si vous souhaitez bloquer le suppression, il suffit de cliquer sur le <a href="<?php echo $url?>">lien</a>
										<br/>
							...
							<a href="mailto:<?php Yii::app()->params['adminEmail'];?>"><?php Yii::app()->params['adminEmail']?></a>
						</th>
				    </tr>
	  			</table>
    		</th>
		...
		<table class="row grey"><tbody><tr>
			<th class="small-12 large-12 columns first last">
      			<table>
        			<tr>
          				<th>
							<p class="text-center footercopy">Propulsé par communecter.org</p>
		                </th>
						<th class="expander"></th>
        			</tr>
      			</table>
