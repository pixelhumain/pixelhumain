    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        <td align="left">
           ...
           <?php echo yii::t("email", "For more details on the user")." ".@$newPendingAdmin["username"]?>, <?php echo yii::t("email","you can visit") ?> <a href="<?php echo Yii::app()->getRequest()->getBaseUrl(true)."/".$this->module->id."#person.detail.id.".(String) @$newPendingAdmin["_id"]."?tpl=directory2"?>"><?php echo yii::t("email","sa fiche profil")?></a>.<br/>
           ...
           <a href="<?php echo Yii::app()->getRequest()->getBaseUrl(true)."/".$this->module->id."#".$type.".directory.id.".(String) $parent["_id"]."?tpl=directory2"?>"><?php echo yii::t("common",$type) ?></a>.
        </td>
      </tr>
      </table>
  </body>
