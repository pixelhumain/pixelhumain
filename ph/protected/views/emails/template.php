        			...
        			<tr>
						<th>
							<center>
								...
								<img src="http://localhost:8888/ph/images/logo-communecter.png" class="swu-logo" alt="Logo Image">
								</a>
							</center>
                		</th>
						<th class="expander"></th>
				...
				<table>
					<tr>
						<th>
							...
							<center>
							<img src="http://localhost:8888/ph/images/logoLTxt.jpg" valign="bottom" alt="Logo Communecter" align="center" class="text-center">
							</center>
						</th>
						<th class="expander"></th>
        			</tr>
		...
		<table class="row"><tbody><tr> <!-- Horizontal Digest Content -->
	      		...
	      		<table>
				    <tr>
					    <th>
							...
							<p>Merci de vous être inscrit sur la réseau social citoyen libre : Communecter.org.</p>
							<p>De voir chaque jour des nouveaux citoyens qui viennent nous rejoindre c’est un plaisir.</p>

							<p>Nous sommes actuellement en période de beta test. Beta test ?!?! Kesako ? </p>                 
							<p>C’est une ouverture partielle : nous venons de terminer le développement de la plateforme et nous avons ouvert la plateforme à des utilisateurs qui nous font des retours (bugs et améliorations) afin de la peaufiner, la simplifier y mettre les derniers coups de peinture avant l’ouverture totale.</p>
							<p>Si vous voulez rejoindre l’équipe de testeur, vous pouvez envoyer un mail à contact@communecter.org et nous vous ouvrirons les accès.</p>

							<p>A très bientôt sur www.communecter.org</p>
							<p>L’équipe de Communecter</p>
						</th>
				    </tr>
	  			</table>
    		</th>
            <th class="small-12 large-3 columns last">
      			<table>
			        <tr>
			        	<th>
			                <a href="#"><img src="http://localhost:8888/ph/images/betatest.png" alt="betatest"></a>
			            </th>
			        </tr>
      			</table>
    		</th>
        			...
        			<tr>
          				<th>
                  			<center>
                    			...
                    			<table class="button text-center"><tr><td><table><tr><td><a href="#">Centered CTA!</a></td></tr></table></td></tr></table>
