            ...
            <ul class="slides">
                ...
                <li>
                	...
                	<div class="gallery-item">
			    		<a href="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/1.jpg" data-fancybox-group="group1" class="fancybox">
			    			<span>Image Title</span>
				    		<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/1.jpg" width="300" height="200" alt="Image gallery">
			    		</a>
		    		</div>
                	<!-- SECOND ITEM GALLERY -->
                	<div class="gallery-item">
			    		<a href="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/2.jpg" data-fancybox-group="group1" class="fancybox">
			    			<span>Image Title</span>
				    		<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/2.jpg" width="300" height="200" alt="Image gallery">
			    		</a>
		    		</div>
                </li>
				<!-- END SLIDE -->
                <li>
                	<div class="gallery-item">
			    		<a href="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/3.jpg" data-fancybox-group="group1" class="fancybox">
			    			<span>Image Title</span>
				    		<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/3.jpg" width="300" height="200" alt="Image gallery">
			    		</a>
		    		</div>
                	<div class="gallery-item">
			    		<a href="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/4.jpg" data-fancybox-group="group1" class="fancybox">
			    			<span>Image Title</span>
				    		<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/4.jpg" width="300" height="200" alt="Image gallery">
			    		</a>
		    		</div>
                </li>
                <li>
                	<div class="gallery-item">
			    		<a href="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/5.jpg" data-fancybox-group="group1" class="fancybox">
			    			<span>Image Title</span>
				    		<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/5.jpg" width="300" height="200" alt="Image gallery">
			    		</a>
		    		</div>
                	<div class="gallery-item">
			    		<a href="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/6.jpg" data-fancybox-group="group1" class="fancybox">
			    			<span>Image Title</span>
				    		<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/gallery/6.jpg" width="300" height="200" alt="Image gallery">
			    		</a>
		    		</div>
                </li>
                <li>
							...
							<div class="event">
								...
								<div class="event-header">
									<a href="single-event.html">
										<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/event/1.jpg" alt="Event cover">
									</a>
								</div>
								<!-- START CONTENT -->
                    ...
                    <li>
                        <div class="slide">
							<div class="event">
								<div class="event-header">
									<a href="single-event.html">
										<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/event/2.jpg" alt="Event cover">
									</a>
								</div>
								<div class="event-content">
									<h3>Event Title</h3>
                    ...
                    <li>
                        <div class="slide">
							<div class="event">
								<div class="event-header">
									<a href="single-event.html">
										<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/event/3.jpg" alt="Event cover">
									</a>
								</div>
								<div class="event-content">
									<h3>Event Title</h3>
                    ...
                    <li>
                        <div class="slide">
							<div class="event">
								<div class="event-header">
									<a href="single-event.html">
										<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/event/4.jpg" alt="Event cover">
									</a>
								</div>
								<div class="event-content">
									<h3>Event Title</h3>
							...
							<div class="post post-normal">
								...
								<div class="post-header">
									<a href="single-blog.html">
										<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/blog/1.jpg" alt="Blog cover">
									</a>
								</div>
                    ...
                    <li>
                        <div class="slide">
							<div class="post post-normal">
								<div class="post-header">
									<a href="single-blog.html">
										<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/blog/2.jpg" alt="Blog cover">
									</a>
								</div>
								<div class="post-content">
									<h3>Post Title</h3>
                    ...
                    <li>
                        <div class="slide">
							<div class="post post-normal">
								<div class="post-header">
									<a href="#">
										<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/blog/3.jpg" alt="Blog cover">
									</a>
								</div>
								<div class="post-content">
									<h3>Post Title</h3>
                    ...
                    <li>
                        <div class="slide">
							<div class="post post-normal">
								<div class="post-header">
									<a href="single-blog.html">
										<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/blog/4.jpg" alt="Blog cover">
									</a>
								</div>
								<div class="post-content">
									<h3>Post Title</h3>
...
<section id="donation" class="section section-image" style="background-image: url('<?php echo Yii::app()->theme->baseUrl;?>/images/donation_cover.jpg');">
