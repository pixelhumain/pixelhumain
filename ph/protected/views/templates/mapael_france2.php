...
$cs->registerScriptFile(Yii::app()->request->baseUrl. '/js/svg/raphael-min.js' , CClientScript::POS_END);
$cs->registerScriptFile(Yii::app()->request->baseUrl. '/js/svg/jquery.mapael.js' , CClientScript::POS_END);
$cs->registerScriptFile(Yii::app()->request->baseUrl. '/js/svg/france_departments.js' , CClientScript::POS_END);
?>
<style>
				.mapTooltip {
		    position : fixed;
	...
	<div class="container">
    	<h1>Population of the 1000 more populated french cities with a legend</h1>

    <div class="maparea5">
        <div class="map">	<span>Alternative content for the map</span>

        </div>
        <div class="cityFrance">	<span>Alternative content for the legend</span>
