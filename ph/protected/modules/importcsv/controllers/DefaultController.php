...
class DefaultController extends Controller {
	...
	Yii::app()->clientScript->registerCssFile(Yii::getPathOfAlias('application.modules.importcsv.assets') . '/styles.css');

	Yii::app()->clientScript->registerScriptFile(Yii::getPathOfAlias('application.modules.importcsv.assets') . '/ajaxupload.js');
	...
	Yii::app()->clientScript->registerScriptFile(Yii::getPathOfAlias('application.modules.importcsv.assets') . '/download.js');
