<ul>
	...
	<li class="block">
		...
		<div class="fss">
			...
			<script>
				function getGroup(){
					testitpost("getGroupResult",'/ph/<?php echo $this::$moduleKey?>/default/getgroupsby',{"email":$("#getGroupemail").val()});
				}
	...
	<li class="block">
		...
		<div class="fss">
			...
			<script>
				function getGroups(){
					testitpost("getGroupsResult",'/ph/<?php echo $this::$moduleKey?>/default/getgroupsby',{"app":"<?php echo $this::$moduleKey?>","groupType":"association"});
				}
			</script>
		</div>
	</li>
