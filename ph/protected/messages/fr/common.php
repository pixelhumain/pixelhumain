...
return array(
	...
	//NOTIFICATIONS
	"You have <span class='notifCount'></span> notifications " => "Vous avez <span class='notifCount'></span> notification(s) ",
	...
	"confirms your invitation and create an account." => "a confirmé votre invitation et créé son compte",
	"wrote a message on your wall" => "a écrit un message dans votre journal",
	// FOOTER
	"Work in Progress" => "Travail en cours",
	
	// Erreurs
	"You have some form errors. Please check below." => "Des erreurs sont présentes. Vérifiez ci-dessous",
	...
	"You are not the creator. Please contact the administrator" => "Vous n&#146;êtes pas le créateur de cette fiche. Veuillez contacter un administrateur",
	...
	"Relation applied successfully" => "La relation a bien été créée",
	...
	"Invitation to project successfully sent" => "L&#146;Invitation à rejoindre le projet a bien été envoyée",
	...
	"New member(s) have been succesfully added"=>"Le(s) nouveau(x) membre(s) a(ont) été ajouté(s) correctement",
	"New member(s) have been succesfully added except those already in the community"=>"Le(s) nouveaux membres a(ont) été ajouté(s) correctement exceptés ceux déjà présents",
	...
	"This user is already connected, but now you follow him"=>"Cet-te utilisateur-rice est déjà connecté-e et mais désormais vous le-la suivez",
	//Infos
	"Remove your last opinion before" => "Enlevez d'abord votre dernière opinion",
	...
	"Please Login First" => "S&#146;il vous plaît, identifiez-vous",
	...
	"Submit" => "Publier", 
	//DATA
	"Your data has been saved" => "Vos données ont bien été enregistrées.",
	...
	"New Event created on " => "Nouvel évènement créé sur ",
	"New Project created on " => "Nouveau projet créée sur ",
	"Confirm your account on " => "Confirmez votre compte sur ",
	...
	"the city" => "la ville",
	"the country" => "le pays",
	"the duration of the event to all day" => "la durée de l'évènement sur toute la journée",
	"the start" => "le début",
	"the end" => "la fin",
	...
	"the fax" => "le fax",
	"the fixe" => "le téléphone fixe",
	"the mobile" => "le téléphone portable",
	"the email" => "l'email",
	...
	"town of" => "commune de",
	"Access to all common information of" => "Accédez aux informations de toute la commune de",
	"empty"=>"vide",
	...
	"Are you sure to not participate to this event" => "Êtes-vous sûr de ne pas participer à cet évènement ?",
	"Are you sure to leave this event"=>"Êtes-vous sûr de quitter cet évènement ?",
	...
	"Are you sure to refuse this invitation" => "Êtes-vous sûr de refuser cette invitation ?",
	"Are you sure to refuse to administrate {what}"=> "Êtes-vous sûr de refuser d&#146;administrer {what} ?",
	...
	"Are you sure you want to help for this need" => "Êtes-vous sûre de confirmer votre aide ?",
	//Indication
	"When" => "Quand",
	"Where" => "Où",
	"From" => "De",
	...
	"search an event ..."=>"rechercher un évènement ...",
	...
	"Send a message to this Event" 			=> "Envoyer un message au(x) responsable(s) de cet évènement",
	...
	"Join this event" 		=> "Rejoindre cet évènement",
	"Go to the event" => "Participer à l'évènement",
	"Join" 							=> "Rejoindre",
	"Manage"						=> "Administrer",
	"added" => "ajouté",
	...
	"Read all news publicated by this event" 		=> "Toute l&#146;actualité de cet évènement",
	...
	"General information about this project" => "Information générale à propos de ce projet",
	...
	"Visible to all and posted on the city's wall"=> "pour tous et partagé dans l'actualité locale",
	...
	"Visible to all and posted on cities' live" => "pour tous et partagé dans l'actualité locale",
	...
	"HELP US : BUGS, IDEAS" => "AIDEZ-NOUS : BUG, IDÉE",
	...
	"Show/Hide old events"=>"Afficher/Cacher les vieux évènements",
	...
	"Add an Event" => "Ajouter un nouvel évènement",
	...
	"City Home page" => "Page d'accueil de cette ville",
	...
	"Create and Attend local events" => "Créez et partagez un évènement local",
	"Promote or contribute to local projects" => "Faites connaître un projet local",
	
	"A person" => "Inviter</br>quelqu'un",
	"An organization" => "Créer</br>une organisation",
	"A project" => "Créer</br>un projet",
	"An event" => "Créer</br>un évènement",
	...
	"Desactivate all"=>"Tout désélectionner",
	"Desactivate all places"=>"Désélectionner tous les lieux",
	"Select all places"=>"Sélectionner tout les lieux",
	"Administrative zone N°2"=>"Zones administratives N°2",
	"Administrative zone N°3"=>"Zones administratives N°3",
	"Administrative zone N°4"=>"Zones administratives N°4",
...
merci de renseigner votre code postal dans l'adresse de votre profil.",
	...
	"Search a events of your city." => "Rechercher les évènements de votre commune.",
	...
	"Disabled" => "Désactivé",
	"Are you sure you want to delete this element ? </br> The element will be deleted : it will not be referenced in all their projects or events. But these last ones will not be deleted. <span class=\"text-red\">Warning:</span> this action can be cancelled only by an administrator" => "Etes-vous sûr(e) de vouloir supprimer cet élément ? </br> L'élément sera supprimé : il ne sera plus référencé dans les évènements/projets qu'il porte. Mais ces derniers ne seront pas supprimés. <span class=\"text-red\">Attention :</span> Cette action ne peut être annulée que par un administrateur !",
	...
	"Organization Disabled" => "Cette organisation est désactivée.",
	"Creator" => "Créateur",
	"This element is in status 'delete pending'. It will be deleted in {nbDaysBeforeDelete} days." => "Cet élément possède le statut 'En cours de suppression'. Il va être supprimé dans {nbDaysBeforeDelete} jour(s).",
	...
	"The element has been put in status 'delete pending', waiting the admin to confirm the delete." => "L'élément a le statut 'suppression en cours', en attendant que le(s) admin(s) confirme(nt) la suppression",
	...
	"Select among my contacts" => "Sélectionner parmi mes contacts",
    ...
    "Materiel Ressource" => "Ressource Matérielle",
    ...
    "trash"         => "Poubelle",
    "history"       => "Histoire",
    "something2See" => "Chose à voir",
    "funPlace"      => "Lieux sympas",
