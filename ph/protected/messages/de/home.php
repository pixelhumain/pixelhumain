<?php
	return array(
		"You're not <span class='text-dark'>communected</span>"=>"Sie sind nicht <span class='text-dark'>communectiert mit uns verbunden</span>",
		"You are"=>"Sie sind",
		...
		"To find easily local actors"=>"um Akteure in seinem Gebiet leicht zu finden",
