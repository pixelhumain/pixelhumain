 ...
 */
	return array(
		"Evaluate your projet as commons"=> "Evaluer votre projet comme un commun", // could you express it in different words? what do yoe mean?
	...
	"Enter the project's start" => "Geben Sie das Datm des Projektstarts ein",
